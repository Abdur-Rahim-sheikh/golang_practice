...
func main() {
	...
	mux.Handle("GET /api/products", http.HandlerFunc(getProducts))
	mux.Handle("POST /api/create-product", http.HandlerFunc(createProduct))
	mux.Handle("OPTIONS /api/create-product", http.HandlerFunc(createProduct))
